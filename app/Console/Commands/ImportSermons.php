    ...
    public function handle(): void
    {
        ...
        foreach ($file_list as $file) {
            ...
            $sermon = Sermon::updateOrCreate(
                ...
                ['delivered_on' => $item['date'], 'location_id' => $item['church']->id, 'feast_id' => $item['feast']->id, 'sermon_text' => $item['text'], 'sermon_markup' => $item['html'], 'file_name' => $item['file_name'], 'file' => $item['path'], 'readings' => $readings, 'title' => $item['title'], 'proper' => $item['proper'], 'mass_year' => $item['mass_year']]
            );
