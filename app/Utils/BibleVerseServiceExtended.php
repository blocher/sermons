 ...
 */
class BibleVerseServiceExtended
{
    ...
    private function initBibleData()
    {
        ...
        $bd [69] ["desc"] ["en"] ["long"] = "1 Maccabees";
        ...
        $bd [70] ["desc"] ["en"] ["long"] = "2 Maccabees";
        ...
        $bd [71] ["desc"] ["en"] ["long"] = "3 Maccabees";
        ...
        $bd [72] ["desc"] ["en"] ["long"] = "Wisdom of Solomon";
        $bd [72] ["desc"] ["en"] ["short"] = "Wis";
        $bd [72] ["pat"] = "/^Weish(eit)?|Wis?|Wisdom|Wisdom of Solomon$/i";
        $bd [72] ["kapAnz"] = 19;
        $bd [72] [1] = 16;
        $bd [72] [2] = 24;
        $bd [72] [3] = 19;
        ...
        $bd [73] ["desc"] ["en"] ["long"] = "Ecclesiasticus";
        $bd [73] ["desc"] ["en"] ["short"] = "Sir";
        $bd [73] ["pat"] = "/^(Jesus ben Sirach|Jesus Sirach|Sirach|Ecclesiasticus|Sir)$/i";
        $bd [73] ["kapAnz"] = 51;
        $bd [73] [1] = 30;
        $bd [73] [2] = 18;
        $bd [73] [3] = 31;
        ...
        $bd [74] ["desc"] ["en"] ["long"] = "Prayer of Manasseh";
        ...
        $bd [77] ["desc"] ["en"] ["long"] = "Epistle of Jeremiah";
        $bd [77] ["desc"] ["en"] ["short"] = "EpJer";
        $bd [77] ["pat"] = "/^(Brief (des )?Jeremia[s]?|BrJe|BrJer|EpJer|Letter of Jeremiah|Epistle of Jeremiah)$/i";
        $bd [77] ["kapAnz"] = 1;
        $bd [77] [1] = 73;
    }
    ...
    public function nonContiguousVersesToString($bibleverses, $lang = "de")
    {
        usort($bibleverses, array('StevenBuehner\BibleVerseBundle\Service\BibleVerseService', 'usortBibleverses'));
        $former = $bibleverses[0];
        $result = $this->bibleVerseToString($former, lang: $lang);
        for ($i = 1; $i < count($bibleverses); ++$i) {

            $current = $bibleverses[$i];
            if ($former->getBookId() != $current->getBookId()) {
                return false;
            }
            if ($former->getToChapter() == $current->getFromChapter()) {
                $result = $result . "," . $current->getFromVerse() . "-" . $current->getToVerse();
            } else {
                $result = $result . "," . $current->getFromChapter() . ":" . $current->getFromVerse() . "-" . $current->getToVerse();
            }
        }
        return $result;
    }
