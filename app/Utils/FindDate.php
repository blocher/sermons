...
/**
 * Edited from https://github.com/etiennetremel/PHP-Find-Date-in-String/blob/master/function.find_date.php
 */
...
class FindDate
{
    public static function findDate($string): Carbon|false
    {
        ...
        $date = Carbon::createFromDate($date['year'], $date['month'], $date['day'], $timezone);
        return $date;
    }
